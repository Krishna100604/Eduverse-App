...
const MainContent = () => {
  return (
    ...
    >
      ...
      >
        <h1 className="text-4xl font-bold mb-4 text-center">Welcome to Eduverse!</h1>
        <p className="leading-relaxed text-center">
          Your ultimate learning assistant, designed to personalize your educational journey.
        </p>
      </motion.section>
      ...
      >
        <h2 className="text-2xl font-bold text-gray-800 mb-4">What is Eduverse?</h2>
        <p className="text-gray-600 leading-relaxed font-bold">
          Eduverse is your personalized learning assistant that adapts to your learning style
          and helps you discover educational resources tailored to your needs.
        </p>
        <p className="text-gray-600 leading-relaxed mt-4 font-bold">
          Whether you're a student preparing for exams, a professional seeking to
          upskill, or an educator looking to enhance teaching methods, Eduverse
          offers a platform designed to meet your learning goals.
        </p>
        <p className="text-gray-600 leading-relaxed mt-4 font-bold">
          With Eduverse, you get access to a vast library of educational content, interactive tools, and personalized learning paths that make learning more effective and enjoyable.
        </p>
      </motion.section>
      ...
      >
        ...
        <p className="leading-relaxed mt-4">
          Eduverse is designed to provide you with the tools and resources you need to succeed in your educational journey, no matter your level or field of study.
        </p>
      </motion.section>
      ...
      >
        ...
        <p className="text-gray-600 leading-relaxed">
          Eduverse offers a range of features to enhance your learning experience:
        </p>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mt-4">
          ...
          >
            <p className="text-gray-800 leading-relaxed">
              "Eduverse has transformed my learning experience. The personalized
              approach and engaging content have helped me stay motivated and
              achieve my goals."
            </p>
          ...
          >
            <p className="text-gray-800 leading-relaxed">
              "As an educator, Eduverse has been an invaluable tool in creating
              interactive lessons and tracking student progress. It's easy to use
              and highly effective."
            </p>
            <p className="text-gray-900 font-medium mt-2">- Jane Smith, Educator</p>
          </motion.div>
        </div>
      </motion.section>
      ...
      >
        ...
        <p className="leading-relaxed">
          Ready to experience personalized learning with Eduverse? Sign up now and
          explore a world of knowledge tailored to your needs.
        </p>
        <Link to="/signup">
          <motion.button
            whileHover={{ scale: 1.05 }}
